...
export const GENRES: Genre[] = [
  { id: 'action', name: 'Action', slug: 'action', description: 'High-energy battles and adventures' },
  { id: 'adventure', name: 'Adventure', slug: 'adventure', description: 'Exciting journeys and quests' },
  { id: 'comedy', name: 'Comedy', slug: 'comedy', description: 'Humorous and lighthearted stories' },
  { id: 'drama', name: 'Drama', slug: 'drama', description: 'Emotional and serious narratives' },
  { id: 'fantasy', name: 'Fantasy', slug: 'fantasy', description: 'Magical worlds and creatures' },
